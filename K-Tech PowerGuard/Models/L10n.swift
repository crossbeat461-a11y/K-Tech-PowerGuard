...
enum L10n {
    ...
    private static let strings: [AppLanguage: [String: String]] = [
        .ja: [
            ...
            "settings.footer_hint": "タブで項目を切り替え、必要な設定にすぐアクセスできます。",
            "glass.title": "ガラス効果",
            "glass.subtitle": "Neo カラーと組み合わせて設定画面の見た目を調整",
            "glass.off": "オフ",
            "glass.light": "弱",
            "glass.medium": "中",
            "glass.strong": "強",
        ...
        .en: [
            ...
            "settings.footer_hint": "Switch tabs to reach the settings you need quickly.",
            "glass.title": "Glass effect",
            "glass.subtitle": "Combine with Neo colors to adjust how Settings looks",
            "glass.off": "Off",
            "glass.light": "Light",
            "glass.medium": "Medium",
            "glass.strong": "Strong",
